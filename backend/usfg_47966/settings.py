"""
Django settings for usfg_47966 project.
...
WSGI_APPLICATION = 'usfg_47966.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "usfg_47966 API",
    "DESCRIPTION": "API documentation for usfg_47966 App",
    "VERSION": "v1",
}
